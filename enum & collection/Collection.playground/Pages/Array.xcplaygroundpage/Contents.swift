...
// ["a", "b", "c"]  "c"가 있는지 찾아서 있으면 인덱스를 알려줘
// ["a", "b", "c"]  c 의 위치는 인덱스 2야
// ["a", "b", "c"]  remove(at: 2)   인덱스
/*:
 ### Sorting
 */
...
// answer
var puppy = ["p", "u", "p", "p", "y"]
if let deletelastP = puppy.lastIndex(of: "p") {
    puppy.remove(at: deletelastP)
}
print(puppy)
...
// answer
let array1 = [1, 2, 4, 8, 9 , 12, 13]
let array2 = [2, 5, 6, 9, 13]
...
let intergerMax = [50, 23, 29, 1, 45, 39, 59, 19, 15]
intergerMax.max()
