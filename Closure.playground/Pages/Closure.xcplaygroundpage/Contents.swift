...
/***************************************************
 ...
 - Global functions: closures that have a name and do not capture any values.   // ex) print(ABC) - free function
...
// 함수도 저장 가능
var function = aFunction        // var function: () -> () = aFunction   () -> () void type
function()
...
// Type Annotation
let closureWithParamAndReturnType1: (String) -> String = { param in     // in - 코드와 구분되기 위해 쓰임
  return param + "!"
}
 ...
 */
// 1번 문제 예.   "Swift" -> 5
let closureString = { (text: String) -> Int in
    return text.count
}
print(closureString("Swift"))

// 2번 문제 예.   5 -> 6
let closureAdd = { anyNum in
    return anyNum + 1
}
print(closureAdd(5))
/*:
...
performClosure(param: {
    return $0.count               // $0 = 변수명 축약      0, 1 : 변수명 순서
})
...
/*:
 ...
 ---
 */
// answer for 정수를 하나 입력받아 2의 배수 여부를 반환하는 클로져

let twoMultiple = { (someNum: Int) -> Bool in
    return someNum % 2 == 0
}
print(twoMultiple(8))
print(twoMultiple(5))

// answer for 정수를 두 개 입력 받아 곱한 결과를 반환하는 클로져
let multiplyTwoNum = { (firstNum: Int, secondNum: Int) -> Int in
    return firstNum * secondNum
}
print(multiplyTwoNum(4, 5))
print(multiplyTwoNum(10, 11))

let multiplyTwoNum2 = { (firstNum, secondNum) -> Int in
    return firstNum * secondNum
}
print(multiplyTwoNum(4, 5))
print(multiplyTwoNum(10, 11))
