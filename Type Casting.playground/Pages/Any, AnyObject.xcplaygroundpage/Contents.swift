...
intArr.append(1)
//intArr.append("1")        //error

strArr.append("1")
//strArr.append(1)          //error


//var someArr = [str, num, str, num]
//type(of: someArr)    // someArr 의 타입은? -> error
...
let anyNum: Any = 5
//var num1: Int = anyNum    // error
//var num2: Int = anyNum as Int   // error : anyNum 이랑 Int 랑 상관이 없다.
//var num3: Int = anyNum as? Int  // error : optinal 이라서 안됨
var num4: Int = anyNum as! Int  // 가능
...
type(of: anyArray[0])
anyArray[0]
//anyArray[0] + 10      // (anyArray[0] as! Int) + 10
type(of: anyArray)
