...
print(greeting["John"]!.lowercased().count.magnitude)       // 옵셔널 제거
/*:
 ---
 ### Question
...
var optionalArr1: [Int]? = [1,2,3] // 배열 자체가 옵셔널
var optionalArr2: [Int?] = [1,2,3] // Int 값들이 옵셔널이며, nil 포함. [optional(1), optional(2), optional(3), nil]
...
print(calculateModulo(op1: 20, op2: 0))
print(calculateModulo(op1: 15, op2: 2))
/*:
 ---
 ### Answer
 ---
