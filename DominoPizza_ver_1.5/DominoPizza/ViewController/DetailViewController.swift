...
class DetailViewController: UIViewController {
    ...
    private func configure() {
        ...
        minusButton.layer.borderColor = #colorLiteral(red: 0.1215686277, green: 0.01176470611, blue: 0.4235294163, alpha: 1)
        minusButton.addTarget(self, action: #selector(buttonAction(_:)), for: .touchUpInside)
        tempView.addSubview(minusButton)
        
        displayLabel.backgroundColor = #colorLiteral(red: 0.1215686277, green: 0.01176470611, blue: 0.4235294163, alpha: 1)
        ...
        plusButton.layer.borderColor = #colorLiteral(red: 0.1215686277, green: 0.01176470611, blue: 0.4235294163, alpha: 1)
