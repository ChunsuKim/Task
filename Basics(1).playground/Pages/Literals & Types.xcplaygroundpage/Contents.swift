...
/*:
 ...
 ### Question
 - UInt에 음수를 넣으면? error
 - Int8 에 127 을 초과하는 숫자를 넣으면? error
 - Int 에 Int32.max ~ Int64.max 사이의 숫자를 넣었을 경우 생각해야 할 내용은? ex) 아이폰5 - 32bit 운영체제
 ---
 */
...
/*:
 ---
 ## Character Literal                       문자 단 1개만 있는 것
 ---
 */
