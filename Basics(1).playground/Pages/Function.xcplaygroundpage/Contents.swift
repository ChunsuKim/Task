...
func hello1() {                     // 입력값이 없는 함수
  print("Hello, world!")
}

func hello2() -> String {           // 문자열을 출력값으로 하는 함수
  return "Hello, world!"
}
...
func say(number: Int) {         // 숫자를 입력값으로 받는 함수
  print(number)
}

func say(word: String) -> Void {            // 문자열을 입력값으로 받은 후 아무것도 반환하지 않는 함수. Void : 아무것도 반환 x
  print(word)
}

func say(something: String) -> () {         // () = Void 같은의미
  print(something)
}
...
//func arithmeticAverage1(_ numbers: Double..., _ last: Double) {
//  print(numbers)
//  print(last)
//}
//
//arithmeticAverage1(1, 2, 3, 5)

//
func arithmeticAverage2(_ numbers: Double..., and last: Double) {
  print(numbers)
  print(last)
}

arithmeticAverage2(1, 2, 3, and: 5)
