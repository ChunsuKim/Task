...
let addingString1 = ["1", "2", "3"].reduce("") { $0 + $1 }
print(addingString1)

let addingString2 = [1, 2, 3].reduce("") { $0 + String($1) }
print(addingString2)
...
/*:
 ---
 ## compactMap
 - 컬렉션의 요소 중 옵셔널 사이에 연산이 있을 경우 옵셔널을 제거
 ---
 */
print("\n---------- [ compactMap ] ----------\n")
...
let flattenArr1 = nestedArr
    .map { $0 }
    .joined()
print(Array(flattenArr1))
